...
os: Sistem hakkında bilgi verir.
...
cls: Output temizler.
data: Veri yönetimi.
rename: Dosyanın adını değiştirir.
---------------------------------------
---------------------------------------
...
customrss: RSS Url'den veri alır.
---------------------------------------
---------------------------------------
en: Klavyeyi İngilizce yapar. (Only Windows)
beep: Beep sesi. (Only Windows)
...
onion: .onion Uzantılı siteleri indexler.
btext: Text tabanlı web tarayıcısı.
tech: Technopat sitesinden haber alır.
kali: Kali Linux sitesinden haber alır.
---------------------------------------
---------------------------------------
...
ytmp3: Mp3 indirici.
dc: Discord servers durumunu gösterir.
---------------------------------------
---------------------------------------
...
ipch: IP sorgu.
port: Port Tarayıcı.       
net: Ağdaki cihazları gösterir. (In Linux's very hard run)
