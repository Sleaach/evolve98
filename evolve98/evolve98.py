...
from application.kali import *
from application.tech import *
from application.distr import *
from application.customrss import *
...
while True:
    dizin = os.getcwd()
    if reset == True:
     main = input(f"\033[32m{oss}@user{Fore.BLUE}{dizin}\033[0m${Fore.WHITE} ").strip().lower()

    if red == True:
     main = input(f"\033[32m{oss}@user{Fore.BLUE}{dizin}\033[0m${Fore.RED} ").strip().lower()

    if blue == True:
     main = input(f"\033[32m{oss}@user{Fore.BLUE}{dizin}\033[0m${Fore.BLUE} ").strip().lower()

    if yellow == True:
     main = input(f"\033[32m{oss}@user{Fore.BLUE}{dizin}\033[0m${Fore.YELLOW} ").strip().lower()

    if green == True:
     main = input(f"\033[32m{oss}@user{Fore.BLUE}{dizin}\033[0m${Fore.GREEN} ").strip().lower()     

    if green == False and reset == False and red == False and blue == False and yellow == False:
     main = input(f"\033[32m{oss}@user{Fore.BLUE}{dizin}\033[0m${Fore.WHITE} ").strip().lower()
    ...
    if main not in [
     ...
     print(f"\n{Fore.RED}Unknown command{Fore.RESET}")
